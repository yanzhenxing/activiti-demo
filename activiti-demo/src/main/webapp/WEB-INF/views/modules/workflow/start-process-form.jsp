...
<head>
	...
	<script type="text/javascript" src="${ctx }/static/js/common/bootstrap.min.js"></script>
	<script type="text/javascript" src="${ctx }/static/js/common/bootstrap-datepicker.js"></script>
...
<body>
	...
	<hr/>
	<form action="${ctx }/workflow/process/start?key=${key}" class="form-horizontal" method="post">
		<%--<c:if test="${hasStartFormKey}">
		${startFormData}
		</c:if> --%>
